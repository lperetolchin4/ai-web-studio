            ...
            <div>
              ...
              <div className="mt-10 max-w-md rounded-2xl border border-white/10 bg-black/20 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-white/55">
                  Для демо используем ориентировочную стоимость за квадратный
                  метр с поправкой на тип объекта. Позже формулу сможем менять
                  под каждого клиента отдельно.
                </p>
              </div>
            </div>
          ...
          <div className="rounded-[32px] bg-[#d7b56d] px-7 py-14 text-black sm:px-12 lg:flex lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-4 text-black/60">
                Следующим шагом подключим сюда настоящую форму заявки.
              </p>
            </div>
